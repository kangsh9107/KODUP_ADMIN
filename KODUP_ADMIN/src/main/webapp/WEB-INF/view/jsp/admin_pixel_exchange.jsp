...
<form style="margin-left:40px;">
   ...
   <div >
	...
	<div class="cho_exchange_list" style="text-align:center;" >
		<div id="exchange_list_filter" style="width:950px;  margin: auto;">
			<div style="float:right;">
				<span>신청일</span>
				<input type="button" value="▲" style="font-size:12px;"><input type="button" value="▼" style="font-size:12px;">
			</div>
			<div style="float:right; margin-right:15px;">
				<span>상태</span>
				<select name="ex_status">
					<option value="exchange_status0">환전대기</option>
				    <option value="exchange_status1">환전승인</option>
				</select>
			</div>
		</div>
		<div id="exchange" style="display:inline-block; margin: auto;">
			<div class='cho_title'>
		      ...
		      <span class='exchange_status'>환전상태</span>
		   ...
		   <div class='item'>
		      ...
		      <span class='exchange_account'>110-1234-1234</span>
		      <span class='exchange_date'>2023-01-03</span>
		   ...
		   <div class='item'>
		      ...
		      <span class='exchange_account'>110-1234-1234</span>
		      <span class='exchange_date'>2023-01-02</span>
		      <span class='exchange_status'>환전승인</span>
		      <span class='exchange_button'><input type="button" value="환전승인"></span>
		   </div>
		   <div class='item'>
		   ...
		   <div class='item'>
		      ...
		      <span class='exchange_account'>110-1234-1234</span>
		      <span class='exchange_date'>2023-01-01</span>
		      <span class='exchange_status'>환전승인</span>
		      <span class='exchange_button'><input type="button" value="환전승인"></span>
		   </div>
		   <div class='item'>
