...
public class AdminPixelPageVo {
	   int totSize; //검색된 결과의 전체 건수
	    ...
	    String sortFilter="desc";//apply_date에 desc를 의미
	    int statusFilter=0;
	    


		public AdminPixelPageVo() {}
		...
		public String getSortFilter() {return sortFilter;}
		public void setSortFilter(String sortFilter) {this.sortFilter = sortFilter;}
